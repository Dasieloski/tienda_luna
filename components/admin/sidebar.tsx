...
const NAV_ITEMS = [
  {
    ...
    items: [
      ...
      { href: "/admin/ventas-web", label: "Ventas Web", icon: Globe },
...
const DEVICES = [{ name: "Caja Principal", version: "v2.1", status: "online" }];
        ...
        <div className="flex h-16 shrink-0 items-center gap-3 px-4 sm:px-5 lg:h-20">
          ...
          >
            <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-tl-accent shadow-sm transition-transform duration-200 ease-out group-hover/logo:scale-[1.03]">
              <Store
                className="h-6 w-6 text-tl-accent-fg transition-transform duration-200 ease-out group-hover/logo:scale-105"
                aria-hidden
              />
            </span>
            <span
              ...
              <div className="min-h-0 overflow-hidden">
                <div className="mt-2 space-y-2">
                  {DEVICES.map((device) => (
                    ...
                    >
                      <Monitor
                        className="h-5 w-5 shrink-0 text-tl-muted"
                        aria-hidden
                      />
